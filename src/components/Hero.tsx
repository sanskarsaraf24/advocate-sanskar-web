...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-20 bg-gradient-to-b from-background to-secondary/30">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-block">
                <p className="text-accent font-semibold tracking-widest uppercase text-sm border-b-2 border-accent pb-1">
                  Legal Excellence
                </p>
              </div>
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative">
              ...
              <img
                ...
                className="relative rounded-sm w-full max-w-md object-cover shadow-2xl border-4 border-card"
              />
            </div>
          </div>
        </div>
