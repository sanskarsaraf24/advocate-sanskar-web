  ...
  return <section id="about" className="py-24 bg-secondary">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center space-y-6 mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">Adv. Sanskar Saraf is an independent legal practitioner primarily focused on civil litigation and arbitration, with a growing emphasis on bank-related disputes, recovery proceedings, and enforcement actions before various courts and tribunals across Delhi.</p>
        ...
        <div className="max-w-4xl mx-auto mt-20">
          ...
          <div className="space-y-8">
            {steps.map(step => <div key={step.number} className="bg-card p-6 rounded-lg border border-border hover:shadow-lg transition-shadow">
